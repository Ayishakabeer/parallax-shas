...
function openlink(x) {
    if (x == 1) {
        window.open("https://www.instagram.com/ayisha_aish_/", "_blank");
    }
    if (x == 2) {
        window.open("https://www.linkedin.com/in/aisha-kabeer-762572320/", "_blank");
    }
    if (x == 3) {
        window.open("https://github.com/Ayishakabeer", "_blank");
    }
